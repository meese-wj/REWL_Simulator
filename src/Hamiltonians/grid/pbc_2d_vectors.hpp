...
template<typename T>
T pbc_add_1d( const size_t L_axis, const T ax1, const T ax2 )
{
    T result = ax1 + ax2;
...
template<typename T>
T pbc_subtract_1d( const size_t L_axis, const T ax1, const T ax2 )
{
    T result = ax1 - ax2;
...
// Add vectors A and B
template<typename T>
pbc_2d_vector<T> pbc_add( const size_t Lx, const size_t Ly, const pbc_2d_vector<T> & A, const pbc_2d_vector<T> & B )
{
...
template<typename T>
pbc_2d_vector<T> pbc_subtract( const size_t Lx, const size_t Ly, const pbc_2d_vector<T> & A, const pbc_2d_vector<T> & B )
{
...
// between two vectors
template<typename O, typename T>
O pbc_distance( const size_t Lx, const size_t Ly, const pbc_2d_vector<T> & A, const pbc_2d_vector<T> & B )
{
...
template<typename O, typename T>
O pbc_scalar_product( const size_t Lx, const size_t Ly, 
