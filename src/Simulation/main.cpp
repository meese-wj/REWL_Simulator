...
int main(int argc, char * argv[])
{
    ...
    if ( world_rank == REWL_MASTER_PROC )
    {
        ...
        Simulated_Annealer<ENERGY_TYPE, Hamiltonian_t<OBS_TYPE>, State_t<OBS_TYPE> > * annealer = new Simulated_Annealer<ENERGY_TYPE, Hamiltonian_t<OBS_TYPE>, State_t<OBS_TYPE> >( (size_t)1e3, 50., 0.5, 500 );
